...
{\ttfamily \#include $<$\mbox{\hyperlink{_l_pfold_8h}{Vienna\+R\+N\+A/\+L\+Pfold.\+h}}$>$}
...
\mbox{\hyperlink{group__local__pf__fold_ga70ec33810fa17a9f67a7c59f156d0137}{vrna\+\_\+probs\+\_\+window()}} 
\end{DoxySeeAlso}
...
{\footnotesize\ttfamily \mbox{\hyperlink{group__struct__utils_gab9ac98ab55ded9fb90043b024b915aca}{vrna\+\_\+ep\+\_\+t}}$\ast$ vrna\+\_\+pfl\+\_\+fold (\begin{DoxyParamCaption}\item[{const char $\ast$}]{sequence,  }\item[{int}]{window\+\_\+size,  }\item[{int}]{max\+\_\+bp\+\_\+span,  }\item[{float}]{cutoff }\end{DoxyParamCaption})}
...
This is a simplified wrapper to \mbox{\hyperlink{group__local__pf__fold_ga70ec33810fa17a9f67a7c59f156d0137}{vrna\+\_\+probs\+\_\+window()}} that given a nucleid acid sequence, a window size, a maximum base pair span, and a cutoff value computes the pair probabilities for any base pair in any window. The pair probabilities are returned as a list and the user has to take care to free() the memory occupied by the list.

\begin{DoxyNote}{Note}
This function uses default model settings! For custom model settings, we refer to the function \mbox{\hyperlink{group__local__pf__fold_ga70ec33810fa17a9f67a7c59f156d0137}{vrna\+\_\+probs\+\_\+window()}}.
\end{DoxyNote}
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{group__local__pf__fold_ga70ec33810fa17a9f67a7c59f156d0137}{vrna\+\_\+probs\+\_\+window()}}, \mbox{\hyperlink{group__local__pf__fold_ga8dc3788e66420f524f2bfc0b685a939d}{vrna\+\_\+pfl\+\_\+fold\+\_\+cb()}}, \mbox{\hyperlink{group__local__pf__fold_ga1dd5c51b797c961124912e289bff553a}{vrna\+\_\+pfl\+\_\+fold\+\_\+up()}}
\end{DoxySeeAlso}
...
A list of base pair probabilities, terminated by an entry with \mbox{\hyperlink{group__struct__utils_a0f8bb11ded4e605f816d7ad92eb568f6}{vrna\+\_\+ep\+\_\+t.\+i}} and \mbox{\hyperlink{group__struct__utils_acada5be62ed6843334a918ca543f0c0d}{vrna\+\_\+ep\+\_\+t.\+j}} set to 0 
\end{DoxyReturn}
...
{\footnotesize\ttfamily void vrna\+\_\+pfl\+\_\+fold\+\_\+cb (\begin{DoxyParamCaption}\item[{const char $\ast$}]{sequence,  }\item[{int}]{window\+\_\+size,  }\item[{int}]{max\+\_\+bp\+\_\+span,  }\item[{\mbox{\hyperlink{_l_pfold_8h_abe710a1182e6db69cc75329dfc9bed67}{vrna\+\_\+probs\+\_\+window\+\_\+callback}} $\ast$}]{cb,  }\item[{void $\ast$}]{data }\end{DoxyParamCaption})}
...
This is a simplified wrapper to \mbox{\hyperlink{group__local__pf__fold_ga70ec33810fa17a9f67a7c59f156d0137}{vrna\+\_\+probs\+\_\+window()}} that given a nucleid acid sequence, a window size, a maximum base pair span, and a cutoff value computes the pair probabilities for any base pair in any window. It is similar to \mbox{\hyperlink{group__local__pf__fold_ga6267230f20cab0e2315375310b4dad85}{vrna\+\_\+pfl\+\_\+fold()}} but uses a callback mechanism to return the pair probabilities.

Read the details for \mbox{\hyperlink{group__local__pf__fold_ga70ec33810fa17a9f67a7c59f156d0137}{vrna\+\_\+probs\+\_\+window()}} for details on the callback implementation!

\begin{DoxyNote}{Note}
This function uses default model settings! For custom model settings, we refer to the function \mbox{\hyperlink{group__local__pf__fold_ga70ec33810fa17a9f67a7c59f156d0137}{vrna\+\_\+probs\+\_\+window()}}.
\end{DoxyNote}
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{group__local__pf__fold_ga70ec33810fa17a9f67a7c59f156d0137}{vrna\+\_\+probs\+\_\+window()}}, \mbox{\hyperlink{group__local__pf__fold_ga6267230f20cab0e2315375310b4dad85}{vrna\+\_\+pfl\+\_\+fold()}}, \mbox{\hyperlink{group__local__pf__fold_ga8958d91b1f1aebfb32b58805d141ccf3}{vrna\+\_\+pfl\+\_\+fold\+\_\+up\+\_\+cb()}}
\end{DoxySeeAlso}
...
{\footnotesize\ttfamily void vrna\+\_\+pfl\+\_\+fold\+\_\+up\+\_\+cb (\begin{DoxyParamCaption}\item[{const char $\ast$}]{sequence,  }\item[{int}]{ulength,  }\item[{int}]{window\+\_\+size,  }\item[{int}]{max\+\_\+bp\+\_\+span,  }\item[{\mbox{\hyperlink{_l_pfold_8h_abe710a1182e6db69cc75329dfc9bed67}{vrna\+\_\+probs\+\_\+window\+\_\+callback}} $\ast$}]{cb,  }\item[{void $\ast$}]{data }\end{DoxyParamCaption})}
...
This is a simplified wrapper to \mbox{\hyperlink{group__local__pf__fold_ga70ec33810fa17a9f67a7c59f156d0137}{vrna\+\_\+probs\+\_\+window()}} that given a nucleic acid sequence, a maximum length of unpaired segments ({\ttfamily ulength}), a window size, and a maximum base pair span computes the equilibrium probability of any segment not exceeding {\ttfamily ulength}. It is similar to \mbox{\hyperlink{group__local__pf__fold_ga1dd5c51b797c961124912e289bff553a}{vrna\+\_\+pfl\+\_\+fold\+\_\+up()}} but uses a callback mechanism to return the unpaired probabilities.
...
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{group__local__pf__fold_ga8dc3788e66420f524f2bfc0b685a939d}{vrna\+\_\+pfl\+\_\+fold\+\_\+cb()}}, \mbox{\hyperlink{group__local__pf__fold_ga8958d91b1f1aebfb32b58805d141ccf3}{vrna\+\_\+pfl\+\_\+fold\+\_\+up\+\_\+cb()}}, \mbox{\hyperlink{group__local__pf__fold_ga296217b76e76e5f7e6927e7210aa9b1f}{V\+R\+N\+A\+\_\+\+P\+R\+O\+B\+S\+\_\+\+W\+I\+N\+D\+O\+W\+\_\+\+B\+PP}}, \mbox{\hyperlink{group__local__pf__fold_ga18325811c7dfc7b7d9d4ac37f4353615}{V\+R\+N\+A\+\_\+\+P\+R\+O\+B\+S\+\_\+\+W\+I\+N\+D\+O\+W\+\_\+\+UP}}, \mbox{\hyperlink{group__local__pf__fold_ga9068f4ec008bf1c042a9357f5c2c5e13}{V\+R\+N\+A\+\_\+\+P\+R\+O\+B\+S\+\_\+\+W\+I\+N\+D\+O\+W\+\_\+\+U\+P\+\_\+\+S\+P\+L\+IT}}
\end{DoxySeeAlso}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{group__local__pf__fold_gab5aa36df48576d25cd42aea2c0bd021d}\label{group__local__pf__fold_gab5aa36df48576d25cd42aea2c0bd021d}} 
\index{Partition Function and Equilibrium Probabilities for Locally Stable Secondary Structures@{Partition Function and Equilibrium Probabilities for Locally Stable Secondary Structures}!update\+\_\+pf\+\_\+params\+L\+P\+\_\+par@{update\+\_\+pf\+\_\+params\+L\+P\+\_\+par}}
\index{update\+\_\+pf\+\_\+params\+L\+P\+\_\+par@{update\+\_\+pf\+\_\+params\+L\+P\+\_\+par}!Partition Function and Equilibrium Probabilities for Locally Stable Secondary Structures@{Partition Function and Equilibrium Probabilities for Locally Stable Secondary Structures}}
\subsubsection{\texorpdfstring{update\+\_\+pf\+\_\+params\+L\+P\+\_\+par()}{update\_pf\_paramsLP\_par()}}
{\footnotesize\ttfamily void update\+\_\+pf\+\_\+params\+L\+P\+\_\+par (\begin{DoxyParamCaption}\item[{int}]{length,  }\item[{\mbox{\hyperlink{group__energy__parameters_ga01d8b92fe734df8d79a6169482c7d8d8}{vrna\+\_\+exp\+\_\+param\+\_\+t}} $\ast$}]{parameters }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \mbox{\hyperlink{group__struct__utils_gab9ac98ab55ded9fb90043b024b915aca}{vrna\+\_\+ep\+\_\+t}}$\ast$ pfl\+\_\+fold (\begin{DoxyParamCaption}\item[{char $\ast$}]{sequence,  }\item[{int}]{win\+Size,  }\item[{int}]{pair\+Size,  }\item[{float}]{cutoffb,  }\item[{double $\ast$$\ast$}]{pU,  }\item[{\mbox{\hyperlink{group__struct__utils_gab9ac98ab55ded9fb90043b024b915aca}{vrna\+\_\+ep\+\_\+t}} $\ast$$\ast$}]{dpp2,  }\item[{F\+I\+LE $\ast$}]{p\+Ufp,  }\item[{F\+I\+LE $\ast$}]{spup }\end{DoxyParamCaption})}
...
\index{Partition Function and Equilibrium Probabilities for Locally Stable Secondary Structures@{Partition Function and Equilibrium Probabilities for Locally Stable Secondary Structures}!pfl\+\_\+fold\+\_\+par@{pfl\+\_\+fold\+\_\+par}}
\index{pfl\+\_\+fold\+\_\+par@{pfl\+\_\+fold\+\_\+par}!Partition Function and Equilibrium Probabilities for Locally Stable Secondary Structures@{Partition Function and Equilibrium Probabilities for Locally Stable Secondary Structures}}
\subsubsection{\texorpdfstring{pfl\+\_\+fold\+\_\+par()}{pfl\_fold\_par()}}
{\footnotesize\ttfamily \mbox{\hyperlink{group__struct__utils_gab9ac98ab55ded9fb90043b024b915aca}{vrna\+\_\+ep\+\_\+t}}$\ast$ pfl\+\_\+fold\+\_\+par (\begin{DoxyParamCaption}\item[{char $\ast$}]{sequence,  }\item[{int}]{win\+Size,  }\item[{int}]{pair\+Size,  }\item[{float}]{cutoffb,  }\item[{double $\ast$$\ast$}]{pU,  }\item[{\mbox{\hyperlink{group__struct__utils_gab9ac98ab55ded9fb90043b024b915aca}{vrna\+\_\+ep\+\_\+t}} $\ast$$\ast$}]{dpp2,  }\item[{F\+I\+LE $\ast$}]{p\+Ufp,  }\item[{F\+I\+LE $\ast$}]{spup,  }\item[{\mbox{\hyperlink{group__energy__parameters_ga01d8b92fe734df8d79a6169482c7d8d8}{vrna\+\_\+exp\+\_\+param\+\_\+t}} $\ast$}]{parameters }\end{DoxyParamCaption})}
