...
\item[\mbox{\hyperlink{callbacks__callbacks000009}{Notes on Callback Functions}}]This function will be called for each suboptimal secondary structure that is successfully backtraced. \end{DoxyRefDesc}
...
md.\mbox{\hyperlink{group__model__details_ade065b814a4e2e72ead93ab502613ed2}{uniq\_ML}} = 1;

\mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\_fold\_compound\_t}} *vc=\mbox{\hyperlink{group__fold__compound_ga6601d994ba32b11511b36f68b08403be}{vrna\_fold\_compound}}(\textcolor{stringliteral}{"GGGGGGAAAAAACCCCCC"}, &md
...
\item[\mbox{\hyperlink{wrappers__wrappers000090}{S\+W\+I\+G Wrapper Notes}}]This function is attached as method {\bfseries \mbox{\hyperlink{group__subopt__wuchty_ga700f662506a233e42dd7fda74fafd40e}{subopt()}}} to objects of type {\itshape fold\+\_\+compound} \end{DoxyRefDesc}
...
\end{DoxyParams}
\begin{DoxyRefDesc}{S\+W\+I\+G Wrapper Notes}
\item[\mbox{\hyperlink{wrappers__wrappers000091}{S\+W\+I\+G Wrapper Notes}}]This function is attached as method {\bfseries subopt\+\_\+cb()} to objects of type {\itshape fold\+\_\+compound} \end{DoxyRefDesc}
...
\index{Suboptimal structures within an energy band arround the M\+FE@{Suboptimal structures within an energy band arround the M\+FE}!subopt\+\_\+par@{subopt\+\_\+par}}
\index{subopt\+\_\+par@{subopt\+\_\+par}!Suboptimal structures within an energy band arround the M\+FE@{Suboptimal structures within an energy band arround the M\+FE}}
\subsubsection{\texorpdfstring{subopt\+\_\+par()}{subopt\_par()}}
{\footnotesize\ttfamily \mbox{\hyperlink{subopt_8h_aa0f46ff02e1017469cf902d02ecd7f9a}{S\+O\+L\+U\+T\+I\+ON}}$\ast$ subopt\+\_\+par (\begin{DoxyParamCaption}\item[{char $\ast$}]{seq,  }\item[{char $\ast$}]{structure,  }\item[{\mbox{\hyperlink{group__energy__parameters_ga8a69ca7d787e4fd6079914f5343a1f35}{vrna\+\_\+param\+\_\+t}} $\ast$}]{parameters,  }\item[{int}]{delta,  }\item[{int}]{is\+\_\+constrained,  }\item[{int}]{is\+\_\+circular,  }\item[{F\+I\+LE $\ast$}]{fp }\end{DoxyParamCaption})}
...
\index{Suboptimal structures within an energy band arround the M\+FE@{Suboptimal structures within an energy band arround the M\+FE}!print\+\_\+energy@{print\+\_\+energy}}
\index{print\+\_\+energy@{print\+\_\+energy}!Suboptimal structures within an energy band arround the M\+FE@{Suboptimal structures within an energy band arround the M\+FE}}
\subsubsection{\texorpdfstring{print\+\_\+energy}{print\_energy}}
{\footnotesize\ttfamily double print\+\_\+energy}
...
\index{Suboptimal structures within an energy band arround the M\+FE@{Suboptimal structures within an energy band arround the M\+FE}!subopt\+\_\+sorted@{subopt\+\_\+sorted}}
\index{subopt\+\_\+sorted@{subopt\+\_\+sorted}!Suboptimal structures within an energy band arround the M\+FE@{Suboptimal structures within an energy band arround the M\+FE}}
