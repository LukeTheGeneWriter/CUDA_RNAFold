...
\item 
\mbox{\hyperlink{structsw_string}{sw\+String}} $\ast$ \mbox{\hyperlink{stringdist_8h_a3125991b3a403b3f89230474deb3f22e}{Make\+\_\+sw\+String}} (char $\ast$string)
...
float \mbox{\hyperlink{stringdist_8h_a89e3c335ef17780576d7c0e713830db9}{string\+\_\+edit\+\_\+distance}} (\mbox{\hyperlink{structsw_string}{sw\+String}} $\ast$T1, \mbox{\hyperlink{structsw_string}{sw\+String}} $\ast$T2)
...
{\footnotesize\ttfamily \mbox{\hyperlink{structsw_string}{sw\+String}}$\ast$ Make\+\_\+sw\+String (\begin{DoxyParamCaption}\item[{char $\ast$}]{string }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily float string\+\_\+edit\+\_\+distance (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structsw_string}{sw\+String}} $\ast$}]{T1,  }\item[{\mbox{\hyperlink{structsw_string}{sw\+String}} $\ast$}]{T2 }\end{DoxyParamCaption})}
