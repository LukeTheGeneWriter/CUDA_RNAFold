...
\begin{DoxyCompactItemize}
\item 
float \mbox{\hyperlink{group__inverse__fold_ga7af026de55d4babad879f2c92559cbbc}{inverse\+\_\+fold}} (char $\ast$\mbox{\hyperlink{special__const_8h_ab53016e6941484f46238d59e2549decb}{start}}, const char $\ast$target)
\begin{DoxyCompactList}\small\item\em Find sequences with predefined structure. \end{DoxyCompactList}\item 
float \mbox{\hyperlink{group__inverse__fold_gaeef52ecbf2a2450ad585a344f9826806}{inverse\+\_\+pf\+\_\+fold}} (char $\ast$\mbox{\hyperlink{special__const_8h_ab53016e6941484f46238d59e2549decb}{start}}, const char $\ast$target)
...
\index{Inverse Folding (\+Design)@{Inverse Folding (\+Design)}!symbolset@{symbolset}}
\index{symbolset@{symbolset}!Inverse Folding (\+Design)@{Inverse Folding (\+Design)}}
\subsubsection{\texorpdfstring{symbolset}{symbolset}}
{\footnotesize\ttfamily char$\ast$ symbolset}
...
This global variable points to the allowed bases, initially \char`\"{}\+A\+U\+G\+C\char`\"{}. It can be used to design sequences from reduced alphabets. 
