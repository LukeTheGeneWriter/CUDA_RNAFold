...
\{
  ...
  \textcolor{keywordtype}{char}  *structure = (\textcolor{keywordtype}{char} *)\mbox{\hyperlink{group__utils_gaf37a0979367c977edfb9da6614eebe99}{vrna\_alloc}}(\textcolor{keyword}{sizeof}(\textcolor{keywordtype}{char}) * (strlen(seq) + 1));

  \textcolor{comment}{/* predict Minmum Free Energy and corresponding secondary structure */}
  \textcolor{keywordtype}{float} mfe = \mbox{\hyperlink{group__mfe__fold__single_ga29a33b2895f4e67b0480271ff289afdc}{vrna\_fold}}(seq, structure);
...
\textcolor{preprocessor}{#include <\mbox{\hyperlink{alifold_8h}{ViennaRNA/alifold.h}}>}
\textcolor{preprocessor}{#include <\mbox{\hyperlink{aln__util_8h}{ViennaRNA/aln\_util.h}}>}
\textcolor{preprocessor}{#include <\mbox{\hyperlink{utils_8h}{ViennaRNA/utils.h}}>}
...
\{
  ...
  \textcolor{keywordtype}{char}        *cons = \mbox{\hyperlink{group__aln__utils_ga8e8b805faaf6dee2feb4cbc38ba48e71}{consensus}}(sequences);

  \textcolor{comment}{/* allocate memory for MFE consensus structure (length + 1) */}
  \textcolor{keywordtype}{char}        *structure = (\textcolor{keywordtype}{char} *)\mbox{\hyperlink{group__utils_gaf37a0979367c977edfb9da6614eebe99}{vrna\_alloc}}(\textcolor{keyword}{sizeof}(\textcolor{keywordtype}{char}) * (strlen(sequences[0]) + 1));

  \textcolor{comment}{/* predict Minmum Free Energy and corresponding secondary structure */}
  \textcolor{keywordtype}{float}       mfe = \mbox{\hyperlink{group__consensus__mfe__fold_ga6c9d3bef3e92c6d423ffac9f981418c1}{vrna\_alifold}}(sequences, structure);
...
\{
  ...
  \textcolor{keywordtype}{char}      *propensity = (\textcolor{keywordtype}{char} *)\mbox{\hyperlink{group__utils_gaf37a0979367c977edfb9da6614eebe99}{vrna\_alloc}}(\textcolor{keyword}{sizeof}(\textcolor{keywordtype}{char}) * (strlen(seq) + 1));

  \textcolor{comment}{/* pointers for storing and navigating through base pair probabilities */}
  \mbox{\hyperlink{group__struct__utils_structvrna__elem__prob__s}{vrna\_ep\_t}} *ptr, *pair\_probabilities = NULL;

  \textcolor{keywordtype}{float}     en = \mbox{\hyperlink{group__pf__fold_gac4a2a74a79e49818bc35412a2b392c7e}{vrna\_pf\_fold}}(seq, propensity, &pair\_probabilities);
  ...
  \textcolor{keywordflow}{for} (ptr = pair\_probabilities; ptr->\mbox{\hyperlink{group__struct__utils_a0f8bb11ded4e605f816d7ad92eb568f6}{i}} != 0; ptr++)
    \textcolor{keywordflow}{if} (ptr->\mbox{\hyperlink{group__struct__utils_a9c09385582d8a7ab00485181f4e868b7}{p}} > 0.5)
      printf(\textcolor{stringliteral}{"p(%d, %d) = %g\(\backslash\)n"}, ptr->\mbox{\hyperlink{group__struct__utils_a0f8bb11ded4e605f816d7ad92eb568f6}{i}}, ptr->\mbox{\hyperlink{group__struct__utils_acada5be62ed6843334a918ca543f0c0d}{j}}, ptr->\mbox{\hyperlink{group__struct__utils_a9c09385582d8a7ab00485181f4e868b7}{p}});
...
\textcolor{preprocessor}{#include <\mbox{\hyperlink{fold__compound_8h}{ViennaRNA/fold\_compound.h}}>}
\textcolor{preprocessor}{#include <\mbox{\hyperlink{mfe_8h}{ViennaRNA/mfe.h}}>}
\textcolor{preprocessor}{#include <\mbox{\hyperlink{string__utils_8h}{ViennaRNA/string\_utils.h}}>}
\textcolor{preprocessor}{#include <\mbox{\hyperlink{utils_8h}{ViennaRNA/utils.h}}>}
...
\{
  ...
  \mbox{\hyperlink{group__utils_ga0ad1f40ea316e5c5918695c35613027a}{vrna\_init\_rand}}();

  \textcolor{comment}{/* Generate a random sequence of 50 nucleotides */}
  \textcolor{keywordtype}{char}                  *seq = \mbox{\hyperlink{group__string__utils_ga4eeb3750dcf860b9f3158249f95dbd7f}{vrna\_random\_string}}(50, \textcolor{stringliteral}{"ACGU"});

  \textcolor{comment}{/* Create a fold compound for the sequence */}
  \mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\_fold\_compound\_t}}  *fc = \mbox{\hyperlink{group__fold__compound_ga6601d994ba32b11511b36f68b08403be}{vrna\_fold\_compound}}(seq, NULL, 
  ...
  \textcolor{comment}{/* predict Minmum Free Energy and corresponding secondary structure */}
  \textcolor{keywordtype}{float}                 mfe = \mbox{\hyperlink{group__mfe__fold_gabd3b147371ccf25c577f88bbbaf159fd}{vrna\_mfe}}(fc, structure);
  ...
  free(seq);
  free(structure);
  \mbox{\hyperlink{group__fold__compound_gadded6039d63f5d6509836e20321534ad}{vrna\_fold\_compound\_free}}(fc);
...
\textcolor{preprocessor}{#include <\mbox{\hyperlink{mfe_8h}{ViennaRNA/mfe.h}}>}
\textcolor{preprocessor}{#include <\mbox{\hyperlink{fold__compound_8h}{ViennaRNA/fold\_compound.h}}>}
\textcolor{preprocessor}{#include <\mbox{\hyperlink{model_8h}{ViennaRNA/model.h}}>}
\textcolor{preprocessor}{#include <\mbox{\hyperlink{string__utils_8h}{ViennaRNA/string\_utils.h}}>}
\textcolor{preprocessor}{#include <\mbox{\hyperlink{utils_8h}{ViennaRNA/utils.h}}>}
...
\{
  ...
  \mbox{\hyperlink{group__model__details_structvrna__md__s}{vrna\_md\_t}} md;

  \textcolor{comment}{/* ALWAYS set default model settings first! */}
  \mbox{\hyperlink{group__model__details_ga8ac6ff84936282436f822644bf841f66}{vrna\_md\_set\_default}}(&md);

  \textcolor{comment}{/* change temperature and activate G-Quadruplex prediction */}
  md.\mbox{\hyperlink{group__model__details_a5f7e5c2b65bada5188443470e576aa4b}{temperature}}  = 25.0; \textcolor{comment}{/* 25 Deg Celcius */}
  md.\mbox{\hyperlink{group__model__details_af88a511a2b1f526b4c6213de6cb8fd6e}{gquad}}        = 1;    \textcolor{comment}{/* Turn-on G-Quadruples support */}

  \textcolor{comment}{/* create a fold compound */}
  \mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\_fold\_compound\_t}}  *fc = \mbox{\hyperlink{group__fold__compound_ga6601d994ba32b11511b36f68b08403be}{vrna\_fold\_compound}}(seq, &md, 
      \mbox{\hyperlink{group__fold__compound_gacea5b7ee6181c485f36e2afa0e9089e4}{VRNA\_OPTION\_DEFAULT}});
...
\textcolor{preprocessor}{#include <\mbox{\hyperlink{fold__compound_8h}{ViennaRNA/fold\_compound.h}}>}
\textcolor{preprocessor}{#include <\mbox{\hyperlink{subopt_8h}{ViennaRNA/subopt.h}}>}
\textcolor{preprocessor}{#include <\mbox{\hyperlink{string__utils_8h}{ViennaRNA/string\_utils.h}}>}
\textcolor{preprocessor}{#include <\mbox{\hyperlink{utils_8h}{ViennaRNA/utils.h}}>}
...
\textcolor{comment}{   */}
  \mbox{\hyperlink{group__subopt__wuchty_ga1053837e6b6f158093508f8a70998352}{vrna\_subopt\_cb}}(fc, 500, &subopt\_callback, (\textcolor{keywordtype}{void} *)&counter);
...
\textcolor{preprocessor}{#include <\mbox{\hyperlink{mfe_8h}{ViennaRNA/mfe.h}}>}
\textcolor{preprocessor}{#include <\mbox{\hyperlink{string__utils_8h}{ViennaRNA/string\_utils.h}}>}
\textcolor{preprocessor}{#include <\mbox{\hyperlink{constraints__soft_8h}{ViennaRNA/constraints\_soft.h}}>}
\textcolor{preprocessor}{#include <\mbox{\hyperlink{utils_8h}{ViennaRNA/utils.h}}>}
...
\{
  ...
  \mbox{\hyperlink{group__soft__constraints_ga069915fe203a2c8e522dd37847177a09}{vrna\_sc\_add\_up}}(fc, 5, -1.7, \mbox{\hyperlink{group__fold__compound_gacea5b7ee6181c485f36e2afa0e9089e4}{VRNA\_OPTION\_DEFAULT}});

  \textcolor{comment}{/* allocate memory for MFE structure (length + 1) */}
  \textcolor{keywordtype}{char}  *structure = (\textcolor{keywordtype}{char} *)\mbox{\hyperlink{group__utils_gaf37a0979367c977edfb9da6614eebe99}{vrna\_alloc}}(\textcolor{keyword}{sizeof}(\textcolor{keywordtype}{char}) * 51);
...
\textcolor{preprocessor}{#include  "\mbox{\hyperlink{_r_n_astruct_8h}{RNAstruct.h}}"}
...
\{
  ...
  \mbox{\hyperlink{struct_tree}{Tree}}        *T1, *T2;
  \mbox{\hyperlink{structsw_string}{swString}}    *S1, *S2;
  ...
  \mbox{\hyperlink{treedist_8h_acbc1cb9bce582ea945e4a467c76a57aa}{free\_tree}}(T1);
  \mbox{\hyperlink{treedist_8h_acbc1cb9bce582ea945e4a467c76a57aa}{free\_tree}}(T2);
...
\textcolor{comment}{   * partition function folding, e.g: */}
  ...
  \mbox{\hyperlink{profiledist_8h_a9b0b84a5a45761bf42d7c835dcdb3b85}{free\_profile}}(pf1);
  \mbox{\hyperlink{profiledist_8h_a9b0b84a5a45761bf42d7c835dcdb3b85}{free\_profile}}(pf2);
\}
\end{DoxyCodeInclude}
 \begin{DoxySeeAlso}{See also}
