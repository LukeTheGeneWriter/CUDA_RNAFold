...
Examples on how to use the new v3.\+0 A\+PI can be found in the \mbox{\hyperlink{mp_example_examples_c_new_API}{Using the \textquotesingle{}new\textquotesingle{} v3.\+0 A\+PI}} section. 