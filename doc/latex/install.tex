...
In the \mbox{\hyperlink{mp_example}{Examples}} and \mbox{\hyperlink{newAPI_newAPI_examples}{Some Examples using R\+N\+Alib A\+PI v3.\+0}} sections, we list a small set of example code that usually is a good starting point for your application.
\end{DoxySeeAlso}
...
\end{DoxyWarning}
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{install_config_generic_hc}{Generic Hard Constraints}} and \mbox{\hyperlink{group__hard__constraints}{Hard constraints}}
\end{DoxySeeAlso}
