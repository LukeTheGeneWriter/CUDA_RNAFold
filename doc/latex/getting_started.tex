...
In the mp\+\_\+example and \mbox{\hyperlink{new_a_p_i_newAPI_examples}{Some Examples using R\+N\+Alib A\+PI v3.\+0}} sections, we list a small set of example code that usually is a good starting point for your application.
\end{DoxySeeAlso}
