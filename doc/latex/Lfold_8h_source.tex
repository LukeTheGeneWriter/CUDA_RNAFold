...
00022 
00023 \textcolor{preprocessor}{#include <\mbox{\hyperlink{mfe_8h}{ViennaRNA/mfe.h}}>}
00024 
00048 \textcolor{keywordtype}{float}
00049 \mbox{\hyperlink{group__local__mfe__fold_ga4918cce52bf69c1913cda503b2ac75d8}{vrna\_Lfold}}( \textcolor{keyword}{const} \textcolor{keywordtype}{char} *\textcolor{keywordtype}{string},
...
00082 \mbox{\hyperlink{group__local__mfe__fold_ga27fddda5fc63eb49c861e38845fc34b4}{vrna\_Lfoldz}}(\textcolor{keyword}{const} \textcolor{keywordtype}{char} *\textcolor{keywordtype}{string},
...
00088 
00089 
00107 \textcolor{keywordtype}{float} \mbox{\hyperlink{group__local__consensus__fold_ga20a173a3cdb83f5d1778e36c1a6b1f2b}{aliLfold}}( \textcolor{keyword}{const} \textcolor{keywordtype}{char} **strings,
...
00112 
00123 DEPRECATED(\textcolor{keywordtype}{float} \mbox{\hyperlink{group__local__mfe__fold_ga16e5a70e60835bb969eaecbe6482f1be}{Lfold}}(\textcolor{keyword}{const} \textcolor{keywordtype}{char} *\textcolor{keywordtype}{string}, \textcolor{keywordtype}{char} *structure, \textcolor{keywordtype}{int} maxdist));
00124 
00132 DEPRECATED(\textcolor{keywordtype}{float} \mbox{\hyperlink{group__local__mfe__fold_gab6d79eecc180f586679f7b85cce5cbe9}{Lfoldz}}(\textcolor{keyword}{const} \textcolor{keywordtype}{char} *\textcolor{keywordtype}{string}, \textcolor{keywordtype}{char} *structure, \textcolor{keywordtype}{int} maxdist, \textcolor{keywordtype}{int} zsc, \textcolor{keywordtype}{double} min\_z));
00133 
